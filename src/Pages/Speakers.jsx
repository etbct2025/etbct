...
const Speakers = () => {
    ...
    const speakers = [
        ...
        { name: "Prof. Ram B. Gupta", designation: "Professor of Chemical & Life Science Engineering, Virginia Commonwealth University, Richmond, USA", photo: ram },
        ...
        { name: "TOUSEEF AMNA", designation: "Department of Biology and Biotechnology, College of Science", photo: tauseef },
        ...
        { name: "Prof Namita Singh", designation: "General Secretary, Association of Microbiologist of India", photo: namita },
...
<div className='flex flex-wrap gap-10 px-16 py-10 justify-center items-center'>
    {
        speakers.map((item,i)=>(
            <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] ">
