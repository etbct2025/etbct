...
const PreviousConfe = () => {
  return (
    ...
    <section className="flex flex-col gap-y-[100px] prev-conferences px-16 py-10">
      ...
      >
        ...
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={first_2022} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={second_2022} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={third_2022} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover" src={fourth_2022} alt="" />
    ...
    <div
      ...
      >
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={first_2019} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={second_2019} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={third_2019} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover" src={fourth_2019} alt="" />
          
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div  className="border rounded-xl h-[550px]">
          <img className="rounded-xl w-full h-full  object-cover " src={fifth_2019} alt="" />
          ...
          >
            ...
            <p className="text-lg text-justify">
            The International Conference on Applied Biology (ICAB-2019) took place at Shri Mata Vaishno Devi University (SMVDU), Katra, in November 2019. Organized by the School of Biotechnology, a leading research-oriented department at SMVDU, the event was inaugurated by Dr. Jitendra Singh, Minister of State, who graced the occasion as the Chief Guest. In his address, Dr. Singh reflected on his close ties with the university and stressed the importance of SMVDU establishing itself in cutting-edge research fields such as Himalayan studies, Atomic Energy, and Space Technology.
            The conference brought together distinguished speakers, participants, and delegates from India and abroad, showcasing the best minds in applied biology. Covering a wide range of topics, including Medicine, Biochemistry, Biotechnology, Zoology, Botany, and Environmental Sciences, the event featured over 20 keynote and invited talks. Its primary goals were to promote international collaboration, offer valuable learning experiences, and inspire participants to contribute to societal advancement through groundbreaking research. With over 300 attendees from various parts of the world, the conference was a resounding success.
            </p>
