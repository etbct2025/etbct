    ...
    <section className="chief-patron  px-8 md:px-16">
      ...
      <div className="flex flex-wrap gap-10 sm:px-16 py-10   justify-center items-center">
        ...
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          <div className=""><img className="rounded-t-xl  h-[250px] w-full sm:h-64 object-cover object-top" src={vinod} alt="" /></div>
          <div className="pb-5">
             <h1 className="text-xl text-yellow-500 text-center">Dr. Vinod Singh</h1>
             <p className="text-lg text-center">Assistant Professor, SoBT</p>
             <p className="text-lg text-center">Co-Organizing Secretary</p>
          </div>
        </motion.div>
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          <div className=""><img className="rounded-t-xl  h-[250px] w-full sm:h-64 object-cover object-center" src={arvind} alt="" /></div>
          <div className="pb-5">
             <h1 className="text-xl text-yellow-500 text-center">Mr. Arvind Kumar Yadav</h1>
             <p className="text-lg text-center">Assistant Professor, SoBT</p>
             <p className="text-lg text-center">Co-Organizing Secretary</p>
          </div>
        </motion.div>
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          <div className=""><img className="rounded-t-xl  h-[250px] w-full sm:h-64 object-cover object-top" src={anil} alt="" /></div>
          <div className="pb-5">
             <h1 className="text-xl text-yellow-500 text-center">Dr. Anil Kumar</h1>
             <p className="text-lg text-center">Assistant Professor, SoBT</p>
             <p className="text-lg text-center">Co-Organizing Secretary</p>
          </div>
        </motion.div>
