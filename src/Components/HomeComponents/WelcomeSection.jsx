     ...
     <>
      <section className="welcome-section flex flex-col gap-y-10 py-16 px-4 sm:px-10">
          <div className='text-center'>
              <motion.h1 initial={{y:100}} whileInView={{y:0}} viewport={{once:true}} className='text-3xl '>Welcome To 3rd <span className="before:block before:absolute before:-inset-1 before:skew-y-6 before:bg-orange-500 relative inline-block">
